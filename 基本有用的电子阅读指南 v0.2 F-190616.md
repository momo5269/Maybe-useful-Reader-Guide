...
- 版式相对复杂、注释较多，比如有侧注数字的情况下，推荐ABBYY PDFT+
...
　不推荐[Readium](https://readium.org/)、[FBReader](https://fbreader.org/)、UWP应用，[Neat Reader](https://www.neat-reader.cn/)等收费软件。打开方式、效率可能均不及次选。
...
　　转换：[Pdg2Pic](https://www.cnblogs.com/stronghorse/p/4913182.html) 可转图片或PDF　安卓：[閑讀書Pdg](https://www.lanzous.com/i3zqnkh) 操作需虚拟按键（如全面屏、三星实体按键可能不显示）
...
　　即.chm文件，已编译的帮助文件（Compiled Help Manual）win下可直接运行，移动端需要阅读器
...
> [`GoldenDict`](https://sourceforge.net/projects/goldendict/files/)([For XP](https://www.pdawiki.com/forum/forum.php?mod=viewthread&tid=34284))　[`灵格斯词霸`](http://www.lingoes.cn/)　[`有道词典纯净版`](http://blog.sina.com.cn/s/blog_89a729a40102wjwf.html)
...
　　目前仅推荐调用互联网公司接口的小软件，专业翻译、写作出版翻译助手和软件本地化暂不收录。
