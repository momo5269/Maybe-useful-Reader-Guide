...
　　导出图片、PitStop、pdftoy流过滤、去水印软件（如[PDF水印清理专家](http://www.liyusoft.com/pdfwr)，PDF Watermark Revmoer）等

　　由于去水印软件通常收费，功能有限或无破解，一般推荐使用[`Acrobat+PitStop`](https://www.jb51.net/softs/624889.html)
...
若是台版书，PDF阅读器很少支持从左到右翻页，但漫画阅读软件（主要指安卓）多数支持，[KOreader](https://github.com/koreader/koreader/wiki/KOReader%E7%BB%B4%E5%9F%BA)也支持。若要单页连续的顺序正确，切割后文件名数字序列化再奇偶对调即可。如[Advanced Renamer](https://www.52pojie.cn/thread-791060-1-1.html) 支持数字文件名加减，可用于对调。
...
[云盘精灵](https://www.yunpanjingling.com/)　百度网盘搜索　*收费*　但效果很好，适合已知有百度网盘资源但加密或失效的。多数资源1豆，1豆最贵3分。
...
　　有时书名/书名+作者无结果也不一定真没有，可以试试ISBN。见过不少次书友求书搜不到了……
...
[贵州省图书馆](http://www.gzlib.com.cn/) 可能杳无音讯，仅作收录 [贵州数字图书馆](http://www.gzlib.org/) 右上角在线领卡注册
...
　　相关软件：[冰点文库下载器](http://www.bingdian001.com/?p=30)　[文献神器](http://www.9312.net/download.html) | [SciHub Desktop](https://zhuanlan.zhihu.com/p/31809890)　[豆丁当当](https://www.52pojie.cn/thread-834272-1-1.html)
...
搜索正确文件名结果**比较可靠**，会有单独种子、种子包含或网盘下载等方式，逐一尝试即可。



中文扫漫有点类似，举个例子`[Dragon.Ball 龍珠完全版][鳥山明][文傳][C.C][34完+2]`能总结出来吗？

明白后，以后用百度、云盘精灵可能会有比较有趣的结果。不过，搜索并非关键。
...
`种子下载`　建议用迅雷以外客户端如[qBittorrent](https://www.qbittorrent.org/)、[tixati](https://www.tixati.com/)添加[Tracker 1](https://github.com/ngosang/trackerslist)或[Tracker 2](https://torrents.me/tracker-list/) 下载。

`种子搜索`　有[Torrentz2](https://torrentz2.eu)、[BTDB](https://btdb.eu)等很多；有些资源[115](https://115.com/)可以秒离线，就是太贵；偶尔可以试试谷歌加入site:vk.com。

`电影下载`　思路和图书、软件类似，但下载站更多，也建议从字幕反推正资源发布名以寻找种子/资源。

`音乐下载`　略有不同，除正版平台外，可尝试[MusicTools](https://www.52pojie.cn/thread-946739-1-1.html)、[全网音乐下载](http://www.myzhangyi.com/music/)。

`汉化漫画　`　引进被BAN或者翻译较差，安卓可以试试 [异次元](https://soft.shouji.com.cn/down/1550728.html)  通过添加[图源](http://gitlab.daguduiyuan.xyz/sheng6364/Source)聚合搜索阅读，详细见评论或官方群

　有时试试`emule`搜索会有意想不到的结果；[DC++](http://dcplusplus.sourceforge.net/)由于各种原因，现在人很少不太推荐，有共享精神仍可以试试。
...
　　本文最早源自给朋友写的小简介，还是聊天时说的，存了TXT。但后来总需要上传文件、TXT也不易看到重点，于是丢进Word、挂上网盘链接、加了点颜色就成了所谓《扫描版图书优化指南》……还发在了论坛。虽然难看，但毕竟只是有限人看。

　　测试了几个版本后，又遇上总问“该用什么打开文件”、“怎么转PDF”等更基础问题的同学……就开始着手写阅读器简介。开始每类说明最多一行……可完善时又想到，单单PDF选择也很多…应尽力介绍各种情况下的阅读器。再加上其他格式，写起来就长了，索性和优化指南合并——也就是本指南的初版。

　　本来觉得初版内容足够。吃饭时一想，阅读过程遇到生僻字、异体字怎么办？再说名字起这么大，也该尽力介绍吧？于是加上了词典翻译、看图截图，甚至还有字幕！再后来还有免费字体、搜索指南什么的，可能用上就写上了…虽然文献管理自觉没能力写好便放弃了。

　　目前版本仍有很多问题：用专用样式排版、全文太长、介绍比较简略、优化指南文字生硬并存在大量歧义等等……但碍于本人第一次用Markdown写作……能力有限，没有较大更新不再变动。
