...
0.2 更新说明
  ...
  3.本文包含少量破解链接，仅供试用：推荐购买正版，亦有免费替代方案；
...
> 漫画	[ComicScreen](https://play.google.com/store/apps/details?id=com.viewer.comicscreen)	

[酷安应用集](https://www.coolapk.com/album/12176502)
...
​		附送个人优化PDF，均书签+标记+OCR+快速Web查看，绝大多数已优化图像
...
​		若同时需要azw/azw3文件的读取，推荐[厚墨](https://www.coolapk.com/apk/cn.deepink.reader)。
...
​		因为水印的情况较多，表达差、说明复杂，请见谅。简单操作可以直接看PitStop。
...
`汉化漫画`引进被BAN或者翻译较差，安卓可以试试 [异次元](https://soft.shouji.com.cn/down/1550728.html)  通过添加图源聚合搜索阅读，详见页面评论
...
吾爱破解此次自查后失效链接如下（按前后顺序），由于非主要能百度到，暂不更新补充。
