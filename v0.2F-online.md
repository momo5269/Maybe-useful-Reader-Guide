...
　　基本常识：`书名` + `作者`/ `出版社` / `年代` 等多种关键词组合搜索，因重名和引擎问题，可能单纯书名无结果。
...
[贵州省图书馆](http://www.gzlib.com.cn/) 在线注册需五日审核通知（可能杳无音讯，仅作收录）

[贵州数字图书馆](http://www.gzlib.org/)：[在线领卡](http://222.85.132.125/reg/showpage.action?s=06CBC178384CE153E195AC6C6676539A)　6个月未登录系统将视为无效卡清除。
...
| 名称                                                         | 更新源   | 地址                                             |
| ------------------------------------------------------------ | -------- | ------------------------------------------------ |
| [`MiniPDF`](http://www.52read.org/forum.php?mod=viewthread&tid=2561) | 暂无更新 |                                                  |
